    ...
    <div data-testid="compliance-page">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-500">
            Review your compliance records across all properties.
          </p>
        </div>
        ...
        {properties.length > 0 && (
          <Button
            ...
            data-testid="go-to-properties-btn"
          >
            Go to Properties
      ...
      {records.length === 0 ? (
        <EmptyState
          ...
          description="Start by adding a property, then create or upload the compliance records you want to track."
          actionLabel="Add Property"
          onAction={() => navigate('/app/properties')}
          tip="A simple start is enough: add one property, then add its first compliance item."
          variant="featured"
        />
      ) : (
        <>
            ...
            {sortedRecords.length === 0 && (
              <div className="py-12 text-center px-6">
                ...
                <p className="text-sm text-slate-500">
                  Try changing the filters to see more compliance records.
                </p>
              </div>
            )}
          </div>
