  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (statusCode === 403 && errorMsg?.includes('limit')) {
        ...
        } else if (errorMsg.toLowerCase().includes('postcode')) {
        ...
        setErrors((prev) => ({
          ...prev,
          general: 'Something went wrong while saving the property.'
        }));
      }
    } finally {
      setLoading(false);
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {property
              ...
              : 'Add the basic details for the property you want to track.'}
          </DialogDescription>
        </DialogHeader>
